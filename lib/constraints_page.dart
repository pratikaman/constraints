...
import 'Extras/AspectRatioWidget.dart';
import 'Extras/FractionallySizedWidget.dart';
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                FractionallySizedWidget(widthFactor: 0.2),
              ],
            ),
            Row(
              crossAxisAlignment: CrossAxisAlignment.start,
...
class Example32 extends Example {
  const Example32({super.key});

  @override
  final code = '';

  @override
  final String explanation = 'Using the LayoutBuilder, you can get the  object, '
      'which can be used for determining the maxWidth and maxHeight of the widget'
      '\nThe main difference between MediaQuery and LayoutBuilder is that'
      ' MediaQuery uses the complete context of the screen rather than just the size of your particular widget, '
      'whereas LayoutBuilder can determine the maximum width and height of a particular widget.';
...
class Example33 extends Example {
  const Example33({super.key});

  @override
  final code = '';

  @override
  final String explanation = 'To determine a widget’s current orientation, you can use the OrientationBuilder class.\n'
      'This is different from the device orientation that you can retrieve by using MediaQuery.';
...
class Example34 extends Example {
  const Example34({super.key});

  @override
  final code = '';

  @override
  final String explanation = 'You can use the AspectRatio widget to size the child to a specific aspect ratio. '
      'This widget first tries the largest width permitted by the layout constraints and '
      'then decides the height by applying the given aspect ratio to the width.';
  ...
  Widget build(BuildContext context) {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            AspectRatioWidget(ratio: '16 / 5'),
            AspectRatioWidget(ratio: '16 / 6'),
          ],
        ),
      ),
    );
